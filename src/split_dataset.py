...
def split_dataset(
    ...
    Returns:
        Path to the output split dataset directory
    """
    ...
    for split_name, split_images in [
        ...
        img_id_mapping = {
            old_id: new_id
            for new_id, old_id in enumerate([img["id"] for img in split_images], 1)
        }
...
def main():
    parser = argparse.ArgumentParser(
        description="Split COCO dataset into train/val/test"
    )
    parser.add_argument(
