...
def main():
    ...
    parser.add_argument(
        "--workspace", type=str, required=True, help="Roboflow workspace name"
    )
    parser.add_argument("--project", type=str, required=True, help="Project name")
    parser.add_argument(
        "--version", type=int, required=True, help="Dataset version number"
    )
    parser.add_argument(
        "--format", type=str, default="yolov8", help="Export format (default: yolov8)"
    )
    parser.add_argument(
        "--location",
        type=str,
